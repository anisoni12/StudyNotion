...
// const { getAllCourseDetails } = require("../controller/Course");
...
router.get("/getCourseDetails",auth, getAllCourseDetails);
...
router.post("/getCourseDetails", auth , getAllCourseDetails)
